  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`/api/place?fields=title,description,mainImage,price,favourites&limit=12&page=${page}&${queryString}`, { withCredentials: true, signal });
